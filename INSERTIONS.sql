...
INSERT ALL
INTO SHIFT VALUES(1, 'Maintenance to Coal Shaft',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('09-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(2, 'Evaluation of Learnership candidates',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('09-05-2021'))
INTO SHIFT VALUES(3, 'Routine Health Inspection',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('10-05-20', 'DD-1M-YYYY'))
INTO SHIFT VALUES(4, 'Meeting with Foreman',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('10-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(5, 'Coal extraction',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('11-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(6, 'Routine inspection of mine safety',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('11-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(7, 'Give training to Learnership students',TO_DATE('25-05-2021', 'DD-MM-YYYY'),TO_DATE('11-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(8, 'Yearly Induction',TO_DATE('25-05-2019', 'DD-MM-YYYY'),TO_DATE('12-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(9, 'Present progress report',TO_DATE('25-05-2019', 'DD-MM-YYYY'),TO_DATE('12-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(10, 'Coal extraction Overtime',TO_DATE('25-05-2019', 'DD-MM-YYYY'),TO_DATE('12-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(11, 'Implementation of new system',TO_DATE('25-05-2019', 'DD-MM-YYYY'),TO_DATE('13-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(12, 'Routine Health Inspection',TO_DATE('25-05-2019', 'DD-MM-YYYY'),TO_DATE('13-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(13, 'Maintenance to Health Gear',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('13-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(14, 'First Aid training received',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('13-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(15, 'Project Phoenix Meeting',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('14-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(16, 'Training received',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('14-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(17, 'Coal extraction',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('15-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(18, 'Routine Health Inspection',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('15-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(19, 'Coal extraction Overtime',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('16-05-2021', 'DD-MM-YYYY'))
INTO SHIFT VALUES(20, 'Coal extraction',TO_DATE('25-05-2020', 'DD-MM-YYYY'),TO_DATE('16-05-2021', 'DD-MM-YYYY'))
SELECT * FROM DUAL;
